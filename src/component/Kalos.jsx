...
function Kalos() {
  ...
  const [loadMore, setLoadMore] = useState("https://pokeapi.co/api/v2/pokemon/?limit=72&offset=649")
...
console.log(screenPokemon);
  ...
  const style = screenPokemon && screenPokemon.types[0].type.name + " screen";
    ...
    <Link to={{pathname:`/${screenPokemon && screenPokemon.id}`}} className={style}>
          {screenPokemon && screenPokemon.sprites.other.dream_world.front_default===null?<img style={{width:"130px"}} src={screenPokemon && screenPokemon.sprites.other["official-artwork"].front_default} alt={screenPokemon && screenPokemon.name} />:<img style={{width:"130px"}} src={screenPokemon && screenPokemon.sprites.other.dream_world.front_default} alt={screenPokemon && screenPokemon.name} />}
